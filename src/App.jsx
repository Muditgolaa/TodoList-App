                ...
                <div key={item.id} className="flex justify-between items-center my-2 p-3 rounded-xl bg-[var(--surface-2)] border border-[var(--border)]">
                  ...
                  <div className="flex h-full">
                    <button
                      ...
                      className="rounded-lg p-2 py-1 text-sm mx-1 bg-[var(--raise)] text-[var(--muted)] hover:text-[var(--amber)] transition-colors"
                    >
                      <FaEdit />
                    </button>
                    <button
                      onClick={(e) => handleDelete(e, item.id)}
                      className="rounded-lg p-2 py-1 text-sm mx-1 bg-[var(--raise)] text-[var(--muted)] hover:text-[var(--amber-2)] transition-colors"
                    >
                      <MdDelete />
                    </button>
                  </div>
